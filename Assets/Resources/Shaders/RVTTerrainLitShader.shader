Shader "Universal Render Pipeline/Terrain/RVT_TerrainLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment SplatmapFragment_VT
        ...
        Pass
        {
            ...
            #pragma vertex ShadowPassVertex_VT
            #pragma fragment ShadowPassFragment_VT
        ...
        Pass
        {
            ...
            #pragma vertex DepthOnlyVertex_VT
            #pragma fragment DepthOnlyFragment_VT
    ...
    // ependency "AddPassShader" = "Hidden/Universal Render Pipeline/Terrain/Lit (Add Pass)"
